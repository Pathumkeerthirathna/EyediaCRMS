...
import CustomerComponent from "../../Components/CustomerComponents/CustomerComponent";
...
export default function CustomerListComponent({ open, onClose, customers }: Props) {
